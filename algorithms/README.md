...
[Common Child](https://www.hackerrank.com/challenges/common-child)|Given two strings a and b of equal length, what's the longest string (s) that can be constructed such that s is a child to both a and b?|[Python](strings/common-child.py) [C++](strings/common-child.cpp)|Medium
...
[Insertion Sort Advanced Analysis](https://www.hackerrank.com/challenges/insertion-sort)|How many shifts will it take Insertion Sort to sort an array?|[Python](arrays-and-sorting/insertion-sort.py) [C++](arrays-and-sorting/insertion-sort.cpp)|Advanced
...
[Taum and B'day](https://www.hackerrank.com/challenges/taum-and-bday)|Calculate the minimum cost required to buy gifts.|[Python](implementation/taum-and-bday.py)|Easy
